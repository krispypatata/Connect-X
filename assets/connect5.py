...
def connect5():
	...
	def winningMove(board, piece):
		...
		# Horizontal Lines
		for column in range(board_COLUMNS-4):
	...
	def saveState(board, player_turn, move):
		fileHandle = open("assets/saves/save_state_7x8.txt", "w")
	...
	def loadState():
		fileHandle = open("assets/saves/save_state_7x8.txt", "r")
			...
			for event in pygame.event.get():
				...
				if event.type == pygame.MOUSEBUTTONDOWN:
					...
					if winningMove(game_board, 1) == True:
						...
						screen.blit(endGameCaption, (193, screenTopSpace + 5))
						totalMoves = endGameFont.render("Total Game Moves: " + str(move), 1, GREEN)
						screen.blit(totalMoves, (130, screenTopSpace + 44))
						...
						fileHandle = open("assets/records/last_played_game_7x8.txt", "w")
					...
					if zeroNotInRow == board_ROWS:
						...
						screen.blit(endGameCaption, (285, screenTopSpace + 5))
						totalMoves = endGameFont.render("Total Game Moves: " + str(move), 1, GREEN)
						screen.blit(totalMoves, (130, screenTopSpace + 44))
					...
					pygame.display.update()
				# end of the loop for pygame events
